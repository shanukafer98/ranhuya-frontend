...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const fetchPhotographyListings = async () => {
      try {
        const res = await fetch(
          `${url}/listing/get?categorie=photography&limit=4`
        );
        const data = await res.json();
    ...
    const fetchDecorationListings = async () => {
      try {
        const res = await fetch(
          `${url}/listing/get?categorie=decoration&limit=4`
        );
        const data = await res.json();
    ...
    const fetchVehicleRentalListings = async () => {
      try {
        const res = await fetch(
          `${url}/listing/get?categorie=vehicleRental&limit=4`
        );
        const data = await res.json();
    ...
    const fetchWeddingCakeListings = async () => {
      try {
        const res = await fetch(
          `${url}/listing/get?categorie=weddingCakes&limit=4`
        );
        const data = await res.json();
        ...
        <div className="relative flex flex-col lg:flex-row gap-6 p-28 px-3 max-w-7xl mx-auto z-10 ">
          <div className="flex flex-col gap-10 lg:w-2/3  pt-12">
            ...
            <div className="text-gray-600 text-lg sm:text-1xl">
              Ranhuya is the best place to find all the wedding services you
      ...
      <div className="max-w-7xl mx-auto p-3 flex flex-col gap-8 my-10 ">
          ...
          <div>
            <div className="my-3">
              ...
              <Link
                ...
                to={"/search?categorie=dj"}
              >
                Show more dj services
              </Link>
            </div>
        ...
        {hotelListings && hotelListings.length > 0 && (
          <div>
            <div className="my-3">
              ...
              <Link
                className="text-sm text-blue-800 hover:underline"
                to={"/search?categorie=hotel"}
              >
                Show more hotel services
              </Link>
            </div>
            <div className="flex flex-wrap gap-4 lg:flex-nowrap">
        ...
        {photographyListings && photographyListings.length > 0 && (
          <div>
            <div className="my-3">
              ...
              <Link
                className="text-sm text-blue-800 hover:underline"
                to={"/search?categorie=photography"}
              >
                Show more photography services
              </Link>
            </div>
            <div className="flex flex-wrap gap-4 lg:flex-nowrap">
        ...
        {decorationListings && decorationListings.length > 0 && (
          <div>
            <div className="my-3">
              ...
              <Link
                className="text-sm text-blue-800 hover:underline"
                to={"/search?categorie=decoration"}
              >
                Show more decoration services
              </Link>
            </div>
            <div className="flex flex-wrap gap-4 lg:flex-nowrap">
        ...
        {ashatakaListings && ashatakaListings.length > 0 && (
          <div>
            <div className="my-3">
              ...
              <Link
                className="text-sm text-blue-800 hover:underline"
                to={"/search?categorie=ashtaka"}
              >
                Show more ashataka services
              </Link>
            </div>
            <div className="flex flex-wrap gap-4 lg:flex-nowrap">
        ...
        {vehicleRentalListings && vehicleRentalListings.length > 0 && (
          <div>
            <div className="my-3">
              ...
              <Link
                className="text-sm text-blue-800 hover:underline"
                to={"/search?categorie=vehicleRental"}
              >
                Show more vehicle rental services
              </Link>
            </div>
            <div className="flex flex-wrap gap-4 lg:flex-nowrap">
        ...
        {weddingCakeListings && weddingCakeListings.length > 0 && (
          <div>
            <div className="my-3">
              <h2 className="text-2xl font-semibold text-slate-600">
                Wedding Cake Listing
              </h2>
              <Link
                className="text-sm text-blue-800 hover:underline"
                to={"/search?categorie=weddingCakes"}
              >
                Show more wedding cake services
              </Link>
            </div>
            <div className="flex flex-wrap gap-4 lg:flex-nowrap">
        ...
        {venueListings && venueListings.length > 0 && (
          <div>
            <div className="my-3">
              ...
              <Link
                className="text-sm text-blue-800 hover:underline"
                to={"/search?categorie=venue"}
              >
                Show more venue services
              </Link>
            </div>
            <div className="flex flex-wrap gap-4 lg:flex-nowrap">
        ...
        {poruwaListings && poruwaListings.length > 0 && (
          <div>
            <div className="my-3">
              ...
              <Link
                className="text-sm text-blue-800 hover:underline"
                to={"/search?categorie=poruwa"}
              >
                Show more poruwa services
              </Link>
            </div>
            <div className="flex flex-wrap gap-4 lg:flex-nowrap">
        ...
        {dancingListings && dancingListings.length > 0 && (
          <div>
            <div className="my-3">
              ...
              <Link
                className="text-sm text-blue-800 hover:underline"
                to={"/search?categorie=dancing"}
              >
                Show more dancing services
              </Link>
            </div>
            <div className="flex flex-wrap gap-4 lg:flex-nowrap">
        ...
        {beraListings && beraListings.length > 0 && (
          <div>
            <div className="my-3">
              ...
              <Link
                className="text-sm text-blue-800 hover:underline"
                to={"/search?categorie=bera"}
              >
                Show more bera services
              </Link>
            </div>
            <div className="flex flex-wrap gap-4 lg:flex-nowrap">
